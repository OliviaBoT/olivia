...
STICKERS = (
    "CAACAgUAAxkBAAEC9B9hTWeFr9SSRi5XUsM2DnfKRVDVxwACngMAAkHqaFa6N8KhhyEAAWkhBA",
    "CAACAgUAAxkBAAEC9CFhTWeIzLWC-vXZBPg99Z1XtvlAvQACcgUAAtniaFZmvzy-RAABcO4hBA",
    "CAACAgUAAxkBAAEC9CNhTWeMMyvrQYf7oVZ5z75yxHM-1wACtgMAAhsMORCyQsEOpHRntSEE",
    "CAACAgUAAxkBAAEC9CVhTWeSVMXMSJmhJudkmneblbHL_AACuAMAAu1maVaKzoUW9-MwPSEE",
    "CAACAgUAAxkBAAEC9CdhTWeUZhpEkpg0GdGSP3QAAVMKJfIAAogDAAIY6GlWuoCaXnWacaIhBA",
    "CAACAgUAAxkBAAEC9ClhTWeXNteV3ZyP-Ko9FKFXmgfUlAAC-AIAAsh6aFagSFAOBUBI9SEE",
    "CAACAgUAAxkBAAEC9CthTWefAAF-z9xa9t9S61Z_f2gAAbKoAAJoAAN77rkcVslqqP9pPSUhBA",
...
async def get_start_func(message, strings, edit=False):
    ...
    buttons.add(    
        InlineKeyboardButton(
            strings["btn_source"], url="https://telegra.ph/file/d29c58ced5067cc20315b.jpg"
        ),
    )
    buttons.add(
        InlineKeyboardButton(strings["btn_channel"], url="https://t.me/bgmicheap_account"),
        InlineKeyboardButton(
            strings["btn_group"], url="https://t.me/useless_group_xd"
        ),
    )
    buttons.add(
        InlineKeyboardButton(
            "👸🏼 Add Ol𝕚ᵛ𝕚a❣️ to your group",
            url=f"https://telegram.me/Miss_OliviboT?startgroup=true",
        )
    )
